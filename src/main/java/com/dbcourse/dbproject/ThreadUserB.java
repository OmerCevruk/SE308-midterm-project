...
public class ThreadUserB extends Thread{
    ...
    int isolationLevel;
    public ThreadUserB(User user, int isolationLevel){
        this.isolationLevel = isolationLevel;
        this.user = user;
    }
    ...
    public void run(){
        try {
            ...
            System.out.println("Error running transaction for user B 2: " + e.getMessage() + e.getErrorCode());
            ...
            System.out.println("Error running transaction for user B: " + e.getMessage());
        }
    }
}
